                                ...
                                @foreach ($latest_posts as $latest_post_item)
                                    ...
                                    <div class="col-md-9">
                                        <div class="align-self-center">
                                            <div class="capsSubtle mb-2"><a href="{{ url(Str::slug($latest_post_item->category->name))}}"> {{ $latest_post_item->category->name }}</a></div>
                                            <h3 class="entry-title mb-3"><a href="{{ url($latest_post_item->category->slug.'/'.$latest_post_item->slug) }}">{{$latest_post_item->name}}</a></h3>
                                            <div class="entry-excerpt">
                                                <p>
                                            ...
                                            <div class="entry-meta align-items-center">
                                                <a href="{{url('profile')}}">{{ $latest_post_item->user->name}}</a> in <a href="#">Freedom</a><br>
                                                <span>{{ $latest_post_item->created_at->format('M j, Y') }}</span>
                                                <span class="middotDivider"></span>
